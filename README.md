...
- **快速建立文章**：可以使用 GitHub 的 **Actions** 頁面，選擇 [Create New Blog Post](https://github.com/sky172839465/astro.yusong.dev/actions/workflows/new-post.yml) 工作流並點擊 `Run workflow` 手動輸入文章資訊，系統會自動建立檔案並發起 Pull Request。
